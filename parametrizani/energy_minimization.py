...
class EnergyMinimizer:
    ...
    def minimize_scan(
        ...
        zero_dihedral : bool
            If True, set the target dihedral potential to 0.
                ...
                for force in system.getForces():
                    if isinstance(force, mm.PeriodicTorsionForce):
                        for j in range(force.getNumTorsions()):
                            ...
                            if ((p1==at1 and p2==at2 and p3==at3 and p4==at4) or
                                (p1==at4 and p2==at3 and p3==at2 and p4==at1)):
                                force.setTorsionParameters(j, p1, p2, p3, p4, periodicity, phase, 0.0*unit.kilojoule_per_mole)
