...
class ConformerGenerator:
    ...
    def generate_dihedral_conformers(
        ...
        constrained : bool
            Whether to apply torsion constraint during optimization.
        constraint_force : float
            Force constant for the torsion constraint.
        ...
        for deg in range(min_angle, max_angle + step, step):
            ...
            if constrained:
                ...
                for atidx in range(mol_copy.GetNumAtoms()):
            ...
            AllChem.MolToMolFile(mol_copy, mol_path)
            AllChem.MolToPDBFile(mol_copy, pdb_path)
